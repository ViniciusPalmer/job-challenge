...
export function ResultContent({ animal, id }: ResultContentProps) {
  ...
  return (
    <article
      ...
      className="w-full rounded-[32px] border border-white/10 bg-slate-950 p-5 shadow-[0_18px_52px_rgba(2,6,23,0.32)] lg:sticky lg:top-6 lg:max-w-[32rem] lg:p-8"
    >
      <img
      ...
      <span className="mb-3 inline-flex rounded-full border border-white/10 bg-slate-900 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-slate-300">
        {animal.type}
      </span>
      ...
      <div className="mb-6 rounded-[24px] border border-white/10 bg-slate-900 p-4 text-slate-200">
